    ...
    return (
        ...
        >
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-2xl font-black text-base-content">Thi Thử</h2>
                    <p className="text-sm text-base-content/60 font-medium">
                        Luyện tập và kiểm tra kiến thức của bạn
                    </p>
                </div>
                ...
                <div className="flex items-center gap-4">
                    ...
                    >
                        <Icon name="Plus" size="md" />Tạo Bài Thi
                    </motion.button>

                    {/* Notifications */}
                    <div className="indicator">
                        {user.notifications > 0 && (
                            <span className="indicator-item badge badge-sm badge-primary">{user.notifications}</span>
                        )}
