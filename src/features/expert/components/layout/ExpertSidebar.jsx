                    ...
                    <div key={section.title} className="mb-3">
                        {!collapsed && (
                            <motion.p
                                initial={{ opacity: 0 }}
                                animate={{ opacity: 1 }}
                                className="px-3 py-1.5 text-[10px] font-bold uppercase tracking-widest text-base-content/40"
                            >
                                {section.title}
                            </motion.p>
                        )}
                        {collapsed && <div className="mx-2 my-2 border-b border-base-300/50" />}
                                        ...
                                        >
                                            ...
                                            {collapsed && (
                                                <div className="pointer-events-none absolute left-full z-[60] ml-3 whitespace-nowrap rounded-xl bg-base-content px-3 py-1.5 text-xs font-bold text-base-100 opacity-0 shadow-xl transition-opacity group-hover:opacity-100">
                                                    {item.label}
                                                    <div className="absolute -left-1 top-1/2 h-2 w-2 -translate-y-1/2 rotate-45 bg-base-content" />
                                                </div>
                                            )}
                                        </Link>
                                    </motion.div>
